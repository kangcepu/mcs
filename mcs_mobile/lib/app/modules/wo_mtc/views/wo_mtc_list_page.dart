...
import '../controllers/wo_mtc_list_controller.dart';
...
class WoMtcListPage extends StatelessWidget {
  const WoMtcListPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(WoMtcListController());
  ...
  Widget _buildFilterChips(WoMtcListController controller) {
    return Obx(() {
  ...
  Widget _buildSearchBar(WoMtcListController controller) {
    return Container(
  ...
  Widget _buildWoList(WoMtcListController controller, int tabIndex) {
    return Obx(() {
  ...
  Widget _buildWoCard(WorkOrderMtc wo, WoMtcListController controller) {
    final headerTitle = [
  ...
  void _showFilterDialog(BuildContext context, WoMtcListController controller) {
  ...
  Widget _buildPriorityFilter(WoMtcListController controller) {
    return Obx(() => Wrap(
          spacing: 8,
          runSpacing: 8,
          children: [
  ...
  Widget _buildStatusFilter(WoMtcListController controller) {
    return Obx(() => Wrap(
          spacing: 8,
          runSpacing: 8,
          children: [
