...
class WoProductionDetailPage extends StatelessWidget {
  const WoProductionDetailPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final WoProductionDetailController controller =
        Get.put(WoProductionDetailController());
  ...
  Widget _buildActionButtons(
      WoProductionDetailController controller, BuildContext context) {
    return Card(
      elevation: 8,
  ...
  void _showApproveDialog(
      BuildContext context, WoProductionDetailController controller) {
  ...
  Future<void> _showAddLaborDialog(
      BuildContext context, WoProductionDetailController controller) async {
  ...
  Widget _buildStatusMessage(WoProductionDetailController controller) {
  ...
  Widget _buildHeaderCard(WoProductionDetailController controller) {
  ...
  Widget _buildDetailsCard(WoProductionDetailController controller) {
    final header = controller.woHeader;
  ...
  Widget _buildServicePhotosCard(WoProductionDetailController controller) {
    return Obx(() {
  ...
  Widget _buildExecutorsCard(WoProductionDetailController controller) {
  ...
  Widget _buildLaborCard(WoProductionDetailController controller) {
  ...
  Widget _buildMaterialCard(WoProductionDetailController controller) {
      ...
      child: Column(
        ...
        children: [
          ...
          ...material.map((item) {
            ...
            if (item is Map) {
              materialName =
                  (item['part'] ?? item['material'] ?? '-').toString();
              final qty =
                  (item['material_request'] ?? item['qty'] ?? 0).toString();
              final unit =
                  (item['uom_request'] ?? item['unit'] ?? '').toString();
