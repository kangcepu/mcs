...
import '../controllers/wo_production_list_controller.dart';
...
class WoProductionListPage extends StatelessWidget {
  const WoProductionListPage({Key? key}) : super(key: key);
  ...
  String _resolvePageTitle() {
    ...
    return 'WO Production';
  }

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(WoProductionListController());
  ...
  Widget _buildFilterChips(WoProductionListController controller) {
    return Obx(() {
  ...
  Widget _buildSearchBar(WoProductionListController controller) {
    return Container(
  ...
  Widget _buildWoList(WoProductionListController controller, int tabIndex) {
    return Obx(() {
  ...
  Widget _buildWoCard(WorkOrder wo, WoProductionListController controller) {
    final headerTitle = [
  ...
  void _showFilterDialog(BuildContext context, WoProductionListController controller) {
  ...
  Widget _buildPriorityFilter(WoProductionListController controller) {
    return Obx(() => Wrap(
          spacing: 8,
          runSpacing: 8,
          children: [
  ...
  Widget _buildStatusFilter(WoProductionListController controller) {
    return Obx(() => Wrap(
          spacing: 8,
          runSpacing: 8,
          children: [
