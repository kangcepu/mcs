...
class WoGaCreatePage extends StatelessWidget {
  const WoGaCreatePage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final WoGaCreateController controller = Get.put(WoGaCreateController());
  ...
  Widget _buildWoNumberField(WoGaCreateController controller) {
  ...
  Widget _buildDateField(WoGaCreateController controller, BuildContext context) {
  ...
  Widget _buildTypeWoDropdown(WoGaCreateController controller) {
  ...
  Widget _buildPriorityDropdown(WoGaCreateController controller) {
    return Obx(() => DropdownButtonFormField<String>(
  ...
  Widget _buildShiftDropdown(WoGaCreateController controller) {
    return Obx(() => DropdownButtonFormField<String>(
  ...
  Widget _buildDivisionDropdown(WoGaCreateController controller) {
  ...
  Widget _buildAssetSelector(WoGaCreateController controller, BuildContext context) {
    return Obx(() => InkWell(
  ...
  void _showAssetPicker(BuildContext context, WoGaCreateController controller) {
  ...
  Widget _buildCompanyField(WoGaCreateController controller) {
    return Obx(() {
  ...
  Widget _buildJobTitleField(WoGaCreateController controller) {
    return TextFormField(
  ...
  Widget _buildRunningHoursField(WoGaCreateController controller) {
    return TextFormField(
  ...
  Widget _buildJobRequirementField(WoGaCreateController controller) {
    return TextFormField(
  ...
  Widget _buildImagePicker(WoGaCreateController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
  ...
  Widget _buildSubmitButton(WoGaCreateController controller) {
    return Obx(() => Container(
      height: 56,
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(16),
