...
class WoListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(WoListController());
  ...
  Widget _buildFilterChips(WoListController controller) {
    return Obx(() {
  ...
  Widget _buildSearchBar(WoListController controller) {
    return Container(
  ...
  Widget _buildWoList(WoListController controller, int tabIndex) {
    return Obx(() {
  ...
  Widget _buildWoCard(WorkOrder wo, WoListController controller) {
    final headerTitle = [
  ...
  void _showFilterDialog(BuildContext context, WoListController controller) {
  ...
  Widget _buildPriorityFilter(WoListController controller) {
    return Obx(() => Wrap(
          spacing: 8,
          runSpacing: 8,
          children: [
  ...
  Widget _buildStatusFilter(WoListController controller) {
    return Obx(() => Wrap(
          spacing: 8,
          runSpacing: 8,
          children: [
