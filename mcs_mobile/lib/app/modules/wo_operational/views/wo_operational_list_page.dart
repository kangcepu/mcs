...
import '../controllers/wo_operational_list_controller.dart';
...
class WoOperationalListPage extends StatelessWidget {
  const WoOperationalListPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(WoOperationalListController());
  ...
  Widget _buildFilterChips(WoOperationalListController controller) {
    return Obx(() {
  ...
  Widget _buildSearchBar(WoOperationalListController controller) {
    return Container(
  ...
  Widget _buildWoList(WoOperationalListController controller, int tabIndex) {
    return Obx(() {
  ...
  Widget _buildWoCard(WorkOrder wo, WoOperationalListController controller) {
    final headerTitle = [
  ...
  void _showFilterDialog(
      BuildContext context, WoOperationalListController controller) {
  ...
  Widget _buildPriorityFilter(WoOperationalListController controller) {
    return Obx(() => Wrap(
          spacing: 8,
          runSpacing: 8,
          children: [
  ...
  Widget _buildStatusFilter(WoOperationalListController controller) {
    return Obx(() => Wrap(
          spacing: 8,
          runSpacing: 8,
          children: [
