...
class WoProductionRepository {
  ...
  Future<Map<String, dynamic>> getWoDetail(String woNumber) async {
    try {
      final response = await _apiService.get(
        ApiConstants.detailWoProduction,
  ...
  Future<Map<String, dynamic>> createWo(FormData formData) async {
    try {
      final response = await _apiService.post(
        ApiConstants.createWoProduction,
        data: formData,
        options: Options(
  ...
  Future<Map<String, dynamic>> updateWo(
      String woNumber, Map<String, dynamic> updateData) async {
    try {
      final response = await _apiService.put(
        ApiConstants.updateWoProduction,
        queryParameters: {'wo_number': woNumber},
        data: updateData,
      );
  ...
  Future<Map<String, dynamic>> approveWo(
    ...
    try {
      final response = await _apiService.post(ApiConstants.approveWoProduction,
  ...
  Future<Map<String, dynamic>> addJobExplanation(
    ...
    try {
      ...
      final response = await _apiService.post(
          ApiConstants.addJobExplanationWoProduction,
          data: formData,
  ...
  Future<Map<String, dynamic>> addLabor(
    ...
    try {
      final response = await _apiService.post(
        ApiConstants.addLaborWoProduction,
        data: {
          'wo_number': woNumber,
  ...
  Future<Map<String, dynamic>> addMaterial(
    ...
    try {
      final response = await _apiService.post(
        ApiConstants.addMaterialWoProduction,
        data: {
          'wo_number': woNumber,
          'job_executor': jobExecutor,
          'material': material,
  ...
  Future<Map<String, dynamic>> completeWo(
    ...
    try {
      final response = await _apiService.post(ApiConstants.completeWoProduction,
  ...
  Future<Map<String, dynamic>> closeWo(String woNumber, String comment) async {
    try {
      final response = await _apiService.post(ApiConstants.closeWoProduction,
          data: {'wo_number': woNumber, 'comment': comment});
      if (response.statusCode == 200) {
        final data = response.data;
        if (data['status'] == true) return data;
  ...
  Future<Map<String, dynamic>> voidWo(String woNumber, String reason) async {
    try {
      final response = await _apiService.post(ApiConstants.voidWoProduction,
  ...
  Future<Map<String, dynamic>> getDashboardStats({
    ...
    try {
      ...
      final response = await _apiService.get(
        ApiConstants.dashboardWoProduction,
        queryParameters: queryParams,
      );
